...
import { createMeshFromPoints, createRectangle, createSVG } from './actor-mesh';
import {
...
export async function createActor(
  ...
  if (box) {
    ...
    mesh = createMeshFromPoints(points, texture, 0.02, 0x00ff00);
  } else {
    mesh = createRectangle(1, 1, texture, 1);
  }
  if (points || svg) {
